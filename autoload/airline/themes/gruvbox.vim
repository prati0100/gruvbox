...
function! airline#themes#gruvbox#refresh()
  ...
  let s:N1 = airline#themes#get_highlight2(['Normal', 'bg'], ['GruvboxPurple', 'fg'])
  ...
  let s:I1 = airline#themes#get_highlight2(['Normal', 'bg'], ['GruvboxOrange', 'fg'])
  let s:I2 = s:N2
  ...
  let s:V1 = airline#themes#get_highlight2(['Normal', 'bg'], ['GruvboxRed', 'fg'])
  let s:V2 = s:N2
